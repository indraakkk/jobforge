...
export class CVFile extends Schema.Class<CVFile>("CVFile")({
  ...
  tailoring_notes: Schema.NullOr(Schema.String),
  target_job_description: Schema.NullOr(Schema.String),
  target_company: Schema.NullOr(Schema.String),
  target_role: Schema.NullOr(Schema.String),
